...
/**
 * 1. ### Challenge `getFilmCount`
 * @instructions
 *  Import data from file data.js using the import/export syntax.
 * /

/**
 * 2. ### Challenge `getFilmCount`
 * @instructions
 * Return the number of elements in the `films` property.
...
/**
 * 3. ### Challenge `getFirstStarshipName`
 * @instructions
...
/**
 * 5. ### Challenge `getVehiclesCostInCreditsSumTotal`
 * @instructions
...
/**
 * 6. ### Challenge `getStarshipPassengerAndCrewSumTotal`
 * @instructions
...
/**
 * 8. ### Challenge `getCargoCapacityTotal`
 * @instructions
...
/**
 * 9. ### Challenge `getFastestStarshipName`
 * @instructions
...
/**
 * 10. ### Challenge `getLargestCargoStarshipModelName`
 * @instructions
...
/**
 * 11. ### Challenge `getSlowestVehicleOrStarshipName`
 * Difficulty: _Tricky_
 *
 * @instructions
